...
public class ConfigurationJPA {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    em.setPackagesToScan(new String[] { "${package}.jpa" });
  ...
  public DataSource dataSource() {
    DataSource ds = (DataSource) getFromInitialContext("java:/${package}.db");
    return ds;
  }
  ...
  private Properties additionalProperties() {
    ...
    final String hibernateProp = Constants.${name_uppercase}_PROPERTY_BASE + "hibernate.";
    final int cutIndex = Constants.${name_uppercase}_PROPERTY_BASE.length();
