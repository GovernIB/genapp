...
public class SelectGroupByAndCountForYearMonth extends SelectMultiple<GroupByValueItem> {
    ...
    public SelectGroupByAndCountForYearMonth(Field<? extends Date> field) throws I18NException {
        super(new Select<?>[] { new SelectCount(), new FieldYear(field).select,
                new FieldMonth(field).select });
        this.field = field;
    ...
    public OrderBy[] getOrderBy() {
        return new OrderBy[] { new OrderBy(fieldYear.select.getSelectString(), OrderType.DESC),
    ...
    public GroupByValueItem objectArrayToI(Object[] objects) throws I18NException {
        ...
        String additionalZero = (month == null) ? ""
        ...
        return new GroupByValueItem(field, label, value, false,
