...
public final class Utils {
    ...
    */
    ...
    public static Object getValueOfJavaField(Object instance, String field) {
        final boolean reportWhenNotFound = true;
        return getValueOfJavaField(instance, field, reportWhenNotFound);
    }

    public static Object getValueOfJavaField(Object instance, String field, boolean reportWhenNotFound) {
        ...
        try {
            ...
            if (reportWhenNotFound) {
                log.warn("Error cercant valor del camp " + field + " de la classe "
