...
public abstract class FilesFormManager <F extends IFile> {
  ...
  protected IFileManager<F> fitxerEjb; 

  public FilesFormManager(IFileManager<F> fitxerEjb) {
  ...
  public void postPersistFiles() throws Exception, I18NException {
  ...
  public class FileFormManager  {
    ...
    */
    ...
    public void postPersist() throws Exception, I18NException {
      if (this.estatPujadaArxiu == null) {
