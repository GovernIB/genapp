...
public class SQL02SelectDistinct extends AbstractUnit {
    ...
    @TutorialPart(
            ...
            description = "The following SQL statement selects all (including the duplicates) values from the \"Country\" column in the \"Customers\" table:",
    ...
    @TutorialPart(
            title = "SELECT DISTINCT Examples - With DISTINCT",
            description = "The following SQL statement selects only the DISTINCT values from the \"Country\" column in the \"Customers\" table:",
    ...
    @TutorialPart(
            title = "SELECT DISTINCT Examples - Count Countries",
            description = "The following SQL statement lists the number customer countries:",
    ...
    @TutorialPart(
            title = "SELECT DISTINCT Examples - Count Distinct Countries",
            description = "The following SQL statement lists the number of different (distinct) customer countries:",
