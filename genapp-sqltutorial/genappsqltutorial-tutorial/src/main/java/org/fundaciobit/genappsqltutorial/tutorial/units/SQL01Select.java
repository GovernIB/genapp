...
public class SQL01Select extends AbstractUnit {
     ...
     */
    @TutorialPart(
            title = "SELECT Column Example",
            description = "The following SQL statement selects the \"CustomerName\" and \"City\" columns from the \"Customers\" table:",
    ...
    @TutorialPart(
            ...
            description = "The following SQL statement selects all the columns from the \"Customers\" table:",
