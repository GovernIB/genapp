...
@TutorialUnit(
        ...
        description = "The WHERE clause can be combined with AND, OR, and NOT operators.\r\n"
...
public class SQL04AndOrNot extends AbstractUnit {
    ...
    @TutorialPart(
            title = "AND Example",
            description = "The following SQL statement selects all fields from \"Customers\" where country is \"Germany\" AND city is \"Berlin\":",
    ...
    @TutorialPart(
            title = "OR Example",
            description = "The following SQL statement selects all fields from \"Customers\" where city is \"Berlin\" OR \"München\":",
    ...
    @TutorialPart(
            title = "OR Example",
            description = "The following SQL statement selects all fields from \"Customers\" where country is \"Germany\" OR \"Spain\":",
    ...
    @TutorialPart(
            title = "NOT Example v1",
            description = "The following SQL statement selects all fields from \"Customers\" where country is NOT \"Germany\":",
    ...
    @TutorialPart(
            ...
            description = "The following SQL statement selects all fields from \"Customers\" where country is \"Germany\" AND city must be \"Berlin\" OR \"München\" (use parenthesis to form complex expressions):",
    ...
    @TutorialPart(
            title = "Combining AND, OR and NOT",
            description = "The following SQL statement selects all fields from \"Customers\" where country is NOT \"Germany\" and NOT \"USA\":",
