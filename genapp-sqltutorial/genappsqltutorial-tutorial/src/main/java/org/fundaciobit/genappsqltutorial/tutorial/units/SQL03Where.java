 ...
 *
 */
@TutorialUnit(title = "SQL WHERE Clause", description = "The WHERE clause is used to filter records.\n"
        + "It is used to extract only those records that fulfill a specified condition.", url = "https://www.w3schools.com/sql/sql_where.asp")
public class SQL03Where extends AbstractUnit {

    @TutorialPart(title = "WHERE Clause Example", description = "The following SQL statement selects all the customers from the country \"Mexico\", in the \"Customers\" table:", sql = "SELECT * FROM Customers WHERE Country='Mexico';", order = 1)
    ...
    @TutorialPart(title = "Text Fields vs. Numeric Fields", description = "SQL requires single quotes around text values (most database systems will also allow double quotes).\r\n"
            + "However, numeric fields should not be enclosed in quotes:", sql = "SELECT * FROM Customers WHERE CustomerID=1;", order = 2)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: Equal(=)", description = "", sql = " SELECT * FROM Products WHERE Price = 18;", order = 10)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: Greater than (>)", description = "", sql = "SELECT * FROM Products WHERE Price > 30;", order = 11)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: Less than (<) ", description = "", sql = "SELECT * FROM Products WHERE Price < 30;", order = 12)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: Greater than or equal (>=)", description = "", sql = "SELECT * FROM Products WHERE Price >= 30;", order = 13)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: Less than or equal (<=)", description = "", sql = "SELECT * FROM Products WHERE Price <= 30;", order = 14)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: Not Equal(<>)", description = "", sql = "SELECT * FROM Products WHERE Price <> 18", order = 15)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: BETWEEN", description = "", sql = "SELECT * FROM Products WHERE Price BETWEEN 50 AND 60;", order = 16)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: LIKE", description = "", sql = "SELECT * FROM Customers WHERE City LIKE 's%';", order = 17)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: IN (array)", description = "", sql = "SELECT * FROM Customers WHERE City IN ('Paris','London')", order = 18)
    ...
    @TutorialPart(title = "Operators in The WHERE Clause: IN (collection)", description = "", sql = "SELECT * FROM Customers WHERE City IN ('Paris','London');", order = 19)
