 ...
 * @author GenApp
 */
@MenuOption(labelCode="suppliers.suppliers.plural", order=90, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/suppliers")
@SessionAttributes(types = { SuppliersForm.class, SuppliersFilterForm.class })
@Tile(name="suppliersFormWebDB", contentJsp="/WEB-INF/jsp/webdb/suppliersForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="suppliers.suppliers")})
@Tile(name="suppliersListWebDB", contentJsp="/WEB-INF/jsp/webdb/suppliersList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="suppliers.suppliers") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Suppliers
   */
  @RequestMapping(value = "/cancel")
  public String cancelSuppliers(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Suppliers_FilterForm_" + this.getClass().getName();
  }
