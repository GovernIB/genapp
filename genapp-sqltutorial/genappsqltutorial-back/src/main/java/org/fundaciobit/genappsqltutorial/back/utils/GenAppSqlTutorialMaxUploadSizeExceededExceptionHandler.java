 ...
 * 
 */
public class GenAppSqlTutorialMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof GenAppSqlTutorialMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof GenAppSqlTutorialMaxUploadSizeExceededException) {
          msgCode = ((GenAppSqlTutorialMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
