 ...
 * @author GenApp
 */
@MenuOption(labelCode="shippers.shippers.plural", order=80, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/shippers")
@SessionAttributes(types = { ShippersForm.class, ShippersFilterForm.class })
@Tile(name="shippersFormWebDB", contentJsp="/WEB-INF/jsp/webdb/shippersForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="shippers.shippers")})
@Tile(name="shippersListWebDB", contentJsp="/WEB-INF/jsp/webdb/shippersList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="shippers.shippers") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Shippers
   */
  @RequestMapping(value = "/cancel")
  public String cancelShippers(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Shippers_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, Shippers shippers) throws I18NException {
