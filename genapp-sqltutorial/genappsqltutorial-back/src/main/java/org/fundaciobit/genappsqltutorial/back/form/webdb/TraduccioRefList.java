...
import org.fundaciobit.genappsqltutorial.ejb.TraduccioService;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    List<org.fundaciobit.genappsqltutorial.model.entity.Traduccio> traduccions = traduccioEjb.select(where);
    ...
    for (org.fundaciobit.genappsqltutorial.model.entity.Traduccio traduccio : traduccions) {
      org.fundaciobit.genappsqltutorial.persistence.TraduccioJPA traduccioJPA = (org.fundaciobit.genappsqltutorial.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      org.fundaciobit.genappsqltutorial.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
