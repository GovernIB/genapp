 ...
 */
@Component
public class GenAppSqlTutorialCommonsMultipartResolver extends
    org.springframework.web.multipart.commons.CommonsMultipartResolver {

  protected final Logger log = Logger.getLogger(getClass());

  public GenAppSqlTutorialCommonsMultipartResolver() {
    super();
  }
  ...
  public MultipartHttpServletRequest resolveMultipart(HttpServletRequest request)
	...
	*/
    ...
    try {
      ...
      throw new GenAppSqlTutorialMaxUploadSizeExceededException(musee.getCause(),
