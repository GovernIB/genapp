...
import org.fundaciobit.genappsqltutorial.back.security.LoginInfo;
 ...
 *
 */
public class GenAppSqlTutorialSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.genappsqltutorial.commons.utils.Configuracio.getDefaultLanguage();
			}
