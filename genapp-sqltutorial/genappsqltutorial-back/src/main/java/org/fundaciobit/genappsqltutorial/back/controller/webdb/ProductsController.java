 ...
 * @author GenApp
 */
@MenuOption(labelCode="products.products.plural", order=70, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/products")
@SessionAttributes(types = { ProductsForm.class, ProductsFilterForm.class })
@Tile(name="productsFormWebDB", contentJsp="/WEB-INF/jsp/webdb/productsForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="products.products")})
@Tile(name="productsListWebDB", contentJsp="/WEB-INF/jsp/webdb/productsList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="products.products") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Products
   */
  @RequestMapping(value = "/cancel")
  public String cancelProducts(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Products_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, Products products) throws I18NException {
