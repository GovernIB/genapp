...
import org.fundaciobit.genappsqltutorial.back.validator.webdb.FitxerWebValidator;
...
public class FitxerController
    extends org.fundaciobit.genappsqltutorial.back.controller.GenAppSqlTutorialBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = org.fundaciobit.genappsqltutorial.ejb.FitxerService.JNDI_NAME)
