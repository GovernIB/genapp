 ...
 * @author GenApp
 */
@MenuOption(labelCode="categories.categories.plural", order=0, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/categories")
@SessionAttributes(types = { CategoriesForm.class, CategoriesFilterForm.class })
@Tile(name="categoriesFormWebDB", contentJsp="/WEB-INF/jsp/webdb/categoriesForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="categories.categories")})
@Tile(name="categoriesListWebDB", contentJsp="/WEB-INF/jsp/webdb/categoriesList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="categories.categories") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void initBinderForm(WebDataBinder binder) {
    ...
    initDisallowedFields(binder, "categories.categoryid");
  }
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Categories
   */
  @RequestMapping(value = "/cancel")
  public String cancelCategories(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Categories_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, Categories categories) throws I18NException {
