...
import org.fundaciobit.genappsqltutorial.persistence.validator.IdiomaValidator;
...
public class IdiomaWebValidator extends AbstractWebValidator<IdiomaForm, Idioma>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.genappsqltutorial.ejb.IdiomaService.JNDI_NAME)
  protected org.fundaciobit.genappsqltutorial.ejb.IdiomaService idiomaEjb;
