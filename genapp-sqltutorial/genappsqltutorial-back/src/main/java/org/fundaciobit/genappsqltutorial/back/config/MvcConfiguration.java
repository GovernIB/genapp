package org.fundaciobit.genappsqltutorial.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.fundaciobit.genappsqltutorial"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new org.fundaciobit.genappsqltutorial.back.utils.GenAppSqlTutorialSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new org.fundaciobit.genappsqltutorial.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new org.fundaciobit.genappsqltutorial.back.utils.GenAppSqlTutorialCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new org.fundaciobit.genappsqltutorial.back.utils.GenAppSqlTutorialMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/genappsqltutorial_genapp", "/WEB-INF/classes/genapp");
