    ...
    <ul class="tree" style="margin: 3px; padding: 0px;">
        ...
        <c:if test="${ empty loginInfo}">
            ...
            <li style="list-style-type: disc; list-style-position: inside;"><a
                href="<c:url value="/public/index.html"/>"> <span style="${(fn:contains(url, 'principal'))? "font-weight:bold;" : ""}">P&agrave;gina
                        Inicial</span>
            </a></li>
        </c:if>
        <c:if test="${not empty loginInfo}">
            ...
            <li style="list-style-type: disc; list-style-position: inside;"><a
                href="<c:url value="/common/principal.html"/>"> <span style="${(fn:contains(url, 'principal'))? "font-weight:bold;" : ""}">Pàgina
                        Inicial</span>
            </a></li>
        </c:if>
        ...
        %>
        <li style="list-style-type: disc; list-style-position: inside;"><a
            href="<c:url value="/public/unit/${classenom}"/>"> <span style="${(fn:contains(url, classenom))? "font-weight:bold;" : ""}"><%=unitat.getIndex()%>
                    - <%=unitat.getNomCurt()%> </span>
        </a></li>
        ...
        <c:if test="${not empty loginInfo}">
            ...
            <li style="list-style-type: disc; list-style-position: inside;"><a
                href="<c:url value="/common/principal.html"/>"> <span style="${(fn:contains(url, 'principal'))? "
   ...
   <sec:authorize access="hasAnyRole('ROLE_SOLI', 'ROLE_DEST', 'ROLE_COLA', 'ROLE_DELE')">
    ...
    --%>
        <%--
            <hr style="margin-top: 6px; margin-bottom: 6px;" />
            <li style="list-style-type: disc; list-style-position: inside;"><a
                href="<c:url value="/common/option2"/>"> <span style="${(fn:contains(url, 'option2'))? "
                    font-weight:bold;" : ""}">Menú Option 2</span>
            </a></li>
