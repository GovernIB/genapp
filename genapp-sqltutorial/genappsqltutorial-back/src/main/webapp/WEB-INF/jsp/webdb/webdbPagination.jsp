...
<div class="row" id="${formName}_pagination" style="width: 100%; text-align: center;">
    ...
    <div class="col" style="float: left;" id="${formName}_pagination_left">
        <c:if test="${__theFilterForm.visibleExportList}">
            ...
            <a href="#" onclick="submitForm('${exportUrl}/<%=dataExporter.getID()%>', true)"> <img
                alt="<%=dataExporter.getName()%>"
    ...
    <div class="col-md-auto text-center" id="${formName}_pagination_center">
    ...
    <div class="col" id="${formName}_pagination_right">
        <div class="row float-right">
            ...
            <form:select cssClass="input-small" cssStyle="width:4em;" onchange="document.${formName}.submit()"
                path="itemsPerPage">
