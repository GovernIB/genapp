      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrderDetailsFields.ORDERDETAILID)}">
            ...
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <form:input cssClass="input-append input-small" path="orderdetailidDesde" />


              <span class="add-on"><fmt:message key="genapp.to" /></span>

              <form:input cssClass="input-append input-small search-query" path="orderdetailidFins" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrderDetailsFields.QUANTITY)}">
            ...
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <form:input cssClass="input-append input-small" path="quantityDesde" />


              <span class="add-on"><fmt:message key="genapp.to" /></span>

              <form:input cssClass="input-append input-small search-query" path="quantityFins" />
