...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <c:choose>
           <c:when test="${__theFilterForm.actionsRenderer == 1}">
            ...
            <a class="btn btn-danger" href="#myModal" role="button"  onclick="openModal('<c:url value="${contexte}/${orderDetails.orderdetailid}/delete"/>','show');" title="<fmt:message key="genapp.delete"/>">
  ...
  <ul class="dropdown-menu float-right" style="min-width:35px;padding:5px 5px 0px 5px;margin:0px;font-size: 12px" >
            <c:if test="${__theFilterForm.editButtonVisible}">
            <li>
            <a class="btn btn-warning btn-sm a_item" style="margin-bottom:5px;color: white;" href="<c:url value="${contexte}/${orderDetails.orderdetailid}/edit"/>" onclick="null">
            <i class="fas fa-edit"></i>
