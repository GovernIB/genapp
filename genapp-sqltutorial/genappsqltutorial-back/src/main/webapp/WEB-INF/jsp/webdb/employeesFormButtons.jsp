...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <div class="navbar-form" style="text-align:right">
    ...
    <input type="button" class="btn btn-secondary" onclick="goTo('<c:url value="${contexte}${__theForm.nou?'':'/'.concat(__theForm.employees.employeeid)}/cancel"/>')" value="<fmt:message key="genapp.cancel"/>">
    </c:if>
    ...
    <c:set var="pk" value="${__theForm.employees.employeeid}"/>
