...
<br/>
<center>
<img src="<c:url value="/img/app-logo.png"/>"  alt="GenAppSqlTutorial" title="GenAppSqlTutorial"/>
...
&#36;{gas:hasRole(ROLE_ADMIN)}= ${gas:hasRole('ROLE_ADMIN')}<br/>
&#36;{gas:hasRole(ROLE_USER) }= ${gas:hasRole('ROLE_USER') }<br/>
