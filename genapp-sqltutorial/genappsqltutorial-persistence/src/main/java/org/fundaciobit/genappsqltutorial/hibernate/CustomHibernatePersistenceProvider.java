package org.fundaciobit.genappsqltutorial.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("org.fundaciobit.genappsqltutorial.hibernate")) {
	        		projecteProperties.put(kStr.replace("org.fundaciobit.genappsqltutorial.",""), v.toString());
