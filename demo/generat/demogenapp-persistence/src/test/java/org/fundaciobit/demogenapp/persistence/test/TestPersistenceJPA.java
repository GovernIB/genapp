package org.fundaciobit.demogenapp.persistence.test;
...
import org.fundaciobit.demogenapp.persistence.DemoGenAppJPADaoManagers;
import org.fundaciobit.demogenapp.model.DemoGenAppDaoManager;
...
public class TestPersistenceJPA {
    ...
    public static final void main(String[] args) {
        try {
            ...
            */
            ...
            IPluginManager pluginMan = DemoGenAppDaoManager.getDaoManagers().getPluginManager();
            ...
            */
             ...
             * IIdiomaManager idioma = DemoGenAppDaoManager.getDaoManagers().getIdiomaManager();
             * 
    ...
    public static EntityManager initDB() {
        ...
        prop.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost:5432/demogenapp");
        prop.put("javax.persistence.jdbc.user", "demogenapp");
        prop.put("javax.persistence.jdbc.password", "demogenapp");

        prop.put("hibernate.connection.driver_class", "org.postgresql.Driver");
        prop.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/demogenapp");
        prop.put("hibernate.connection.username", "demogenapp");
        prop.put("hibernate.connection.password", "demogenapp");
        ...
        emf = Persistence.createEntityManagerFactory("demogenappPULocal", prop);

        EntityManager em = emf.createEntityManager();

        em.setFlushMode(FlushModeType.AUTO);
        
        DemoGenAppDaoManager.setDaoManagers(new DemoGenAppJPADaoManagers(em)); 
