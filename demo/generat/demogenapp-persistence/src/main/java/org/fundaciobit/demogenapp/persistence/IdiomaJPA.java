...
@Table(name = "dem_idioma" , indexes = { 
        @Index(name="dem_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="dem_idioma_seq", allocationSize=1, initialValue=1000)
 ...
 // ---------------  STATIC METHODS ------------------
  ...
  static IdiomaJPA copyJPA(IdiomaJPA __jpa,
    ...
    if(!"AlumneJPA".equals(origenJPA) 
      ...
      __tmp.setAlumnes(AlumneJPA.copyJPA(__jpa.getAlumnes(), __alreadyCopied,"IdiomaJPA"));
    }
