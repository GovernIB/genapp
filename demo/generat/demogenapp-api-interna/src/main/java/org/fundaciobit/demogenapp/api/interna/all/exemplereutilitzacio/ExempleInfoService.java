package org.fundaciobit.demogenapp.api.interna.all.exemplereutilitzacio;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de DemoGenApp - Dades Obertes",
                description = "Exemple de Servei de Dades Reutilitzables emprant paginació i retorn complet de dades",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/demogenapp/tree/demogenapp-1.0/demogenapp-api-interna-client-dadesobertes-v1"))
