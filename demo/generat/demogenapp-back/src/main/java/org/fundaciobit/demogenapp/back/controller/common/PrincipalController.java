package org.fundaciobit.demogenapp.back.controller.common;
...
public class PrincipalController {
	...
	public ModelAndView principal(HttpSession session, HttpServletRequest request, HttpServletResponse response)
		...
		if (initialized == null) {
			HtmlUtils.saveMessageInfo(request, "MessageInfo : Benvingut a DemoGenApp");
	...
	public ModelAndView canviarIdioma(HttpServletRequest request, HttpServletResponse response,
		...
		org.fundaciobit.demogenapp.back.utils.DemoGenAppSessionLocaleResolver.setLocaleManually(request, idioma);		
		return new ModelAndView("principal");
	}
