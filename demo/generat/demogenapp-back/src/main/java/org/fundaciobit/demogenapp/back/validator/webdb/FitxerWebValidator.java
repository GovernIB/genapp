...
import org.fundaciobit.demogenapp.persistence.validator.FitxerValidator;
...
public class FitxerWebValidator extends AbstractWebValidator<FitxerForm, Fitxer>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.demogenapp.ejb.FitxerService.JNDI_NAME)
  protected org.fundaciobit.demogenapp.ejb.FitxerService fitxerEjb;
