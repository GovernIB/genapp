 ...
 */
@Component
public class AlumneRefList extends RefListBase implements AlumneFields {
    ...
    public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
        ...
        _w1 = org.fundaciobit.demogenapp.model.fields.TraduccioFields.TRADUCCIOID.in(alumneEjb.getSubQuery(_transSelect, where));
