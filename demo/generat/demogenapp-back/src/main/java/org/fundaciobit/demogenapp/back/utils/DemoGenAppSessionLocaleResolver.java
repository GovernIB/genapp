 ...
 *
 */
public class DemoGenAppSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.demogenapp.commons.utils.Configuracio.getDefaultLanguage();
			}
