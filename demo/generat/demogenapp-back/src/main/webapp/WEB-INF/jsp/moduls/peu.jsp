<%@page import="org.fundaciobit.demogenapp.logic.utils.LogicUtils"%>
<%@page import="org.fundaciobit.demogenapp.commons.utils.Configuracio"%>
...
<footer id="footer">
	...
	<div class="row mr-auto ml-3 mr-3 peuResponsive">
		...
		<div class="col-4 text-right" >
			<a href="https://governdigital.fundaciobit.org/"  target="_blank"> <img style="padding-top: 10px"
