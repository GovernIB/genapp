      ...
      <script type="text/javascript">
        ...
        <tr id="fitxer_mime_rowid">
          ...
          <td id="fitxer_mime_columnvalueid">
            ...
            <form:input readonly="${ gen:contains(__theForm.readOnlyFields ,FitxerFields.MIME)? 'true' : 'false'}" cssClass="w-75 form-control  ${gen:contains(__theForm.readOnlyFields ,FitxerFields.MIME)? ' uneditable-input' : ''}"  style="" maxlength="45" path="fitxer.mime"   />
