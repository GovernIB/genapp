...
public class HtmlPageGenerator {
	...
	private String getHtmlHeader() {
		...
		return "<%@ page language=\"java\" extends=\"" + project.getPackageName() + "." + WebGenerator.WEB_PACKAGE_NAME
				+ "." + project.getProjectName() + "JspBase\"  contentType=\"text/html;"
				...
				+ formCode.toString() + "   <input type=\"hidden\" name=\"loadedPage\" value=\"true\">\n"
	...
	private String generateButtonBar(String tableName) {
		...
		final String tab = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		return "<% String hideHeader = request.getParameter(\"hideHeader\");\n" + " if (hideHeader != null) { %>\n"
				+ "  <input type=\"hidden\" name=\"hideHeader\" value=\"true\">\n" + " <% } else { %>\n" + "<table "
				+ tableClass + ">" + "\n" + "<tr " + style + ">" + "\n" + "  <td " + style + "><a href=\""
				+ TableManagerJsp + "\">" + "<img src=\"./images/home.gif\"></a></td>" + "\n" + "  <td " + style
				+ "><a href=\"" + TableManagerJsp + "\">Home</a></td>" + "\n" +

				"  <td " + style + "> &nbsp;&nbsp;&nbsp; </td>\n" + "  <td " + style + "><a href=\"" + tableName
				+ "_List.jsp\">" + "<img src=\"./images/list.gif\"></a></td>" + "\n" + "  <td " + style + "><a href=\""
				+ tableName + "_List.jsp\">Llistat</a></td>\n" +

				"  <td " + style + "> &nbsp;&nbsp;&nbsp; </td>\n" + "  <td " + style + "><a href=\"" + tableName
				+ "_New.jsp\">" + "<img src=\"./images/new.gif\"></a></td>" + "\n" + "  <td " + style + "><a href=\""
				+ tableName + "_New.jsp\">" + "Nou Element</a></td>" + "\n" +

				"  <% if(isSecurityEnabled()) { %>\n" + "  <td " + style + ">" + "     <table " + tableClass + ">"
				+ "\n" + "       <tr><td " + style + ">" + tab
				+ "Usuari:<b>'<%=session.getAttribute(FULLNAME) + \"  \" + "
	...
	private String getHtmlFooter() {
		...
		if (submitButton != null) {
			...
			but.append("    <INPUT type=\"submit\" name=\"" + SUBMITBUTTON + "\" value=\"" + submitButton.getName()
					+ "\">\n");
