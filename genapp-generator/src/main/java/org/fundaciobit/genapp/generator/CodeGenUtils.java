...
public class CodeGenUtils {
    ...
    public static String generateGetSetBean(FieldInfo field, boolean generateSet) {
        ...
        return generateGetSetBean(javaName, classeStr, generateSet);
    }
    ...
    public static String set(FieldInfo field) {
        return "set" + Character.toUpperCase(field.getJavaName().charAt(0)) + field.getJavaName().substring(1);
    }
    ...
    public static String getModelName(String tableJavaName) {
        return Character.toLowerCase(tableJavaName.charAt(0)) + tableJavaName.substring(1);
    }
    ...
    public static String isOnlyName(String javaField) {
        return "is" + Character.toUpperCase(javaField.charAt(0)) + javaField.substring(1);
    }
