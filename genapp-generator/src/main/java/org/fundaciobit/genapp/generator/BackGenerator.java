...
public class BackGenerator {
  ...
  public static List<SourceFile> generateValidator(String packageValidatorBack,
    ...
    for (int i = 0; i < tables.length; i++) {
      ...
      code.append("public class " + validator + " extends " + AbstractWebValidator.class.getSimpleName() +  "<" + form + ", " + interfaceBeanModel + ">");
      ...
      code.append("  protected " + logicValidator + "<" + interfaceBeanModel + "> validator = new " + logicValidator + "<" + interfaceBeanModel + ">();\n");
      ...
      */
      ...
      code.append("  @Override\n");
      code.append("  public void validate(" + form +" __form, " + interfaceBeanModel + " __bean, Errors errors) {\n");
      code.append("\n");
...
//      code.append("    boolean isNou =  nou != null && nou.booleanValue();\n");
    ...
    code.append("    }\n");
      ...
      if (transFields != null && transFields.size() != 0) {
        ...
        */
        ...
        for (FieldInfo fieldInfo : transFields) {
          ...
          code.append("      " + jpaPackage+ ".TraduccioJPA tradJPA = __jpa." + CodeGenUtils.get(fieldInfo).replace("ID()", "()") +";\n");
          ...
          String path = baseFormulari + "." + fieldInfo.getJavaName().substring(0, fieldInfo.getJavaName().length() - 2);
      ...
      code.append("    	       wvr.rejectValue(i18nFieldError.getField(), i18nFieldError.getTranslation().getCode(), i18nFieldError.getTranslation().getArgs());\n");
      code.append("        }\n");
      code.append("    }\n");
      code.append("\n");
