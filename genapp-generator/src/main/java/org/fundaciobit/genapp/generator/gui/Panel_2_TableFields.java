...
//= new JTextField(30);
    ...
    public boolean initPanel() {
        try {
            ...
            taula.setDefaultRenderer(JButton.class, new JTableButtonRenderer(defaultRenderer));
    ...
    private void initTable(int defIndex) throws Exception {
        ...
        TableModelColumnList tmcl = new TableModelColumnList(tableName, tableInfo.getFields());
        taula.setModel(tmcl);
        ...
        ColumnConfig[] areaColumns = new ColumnConfig[] { ColumnConfig.FOREIGNKEYS, ColumnConfig.WEBQUERY,
                ColumnConfig.WEBQUERYVALUE };
        ...
        /*
         * TableColumn col =
         * taula.getColumnModel().getColumn(ColumnConfig.WEBTYPE.index);
         * col.setCellEditor(new MyComboBoxEditor(values)); // If the cell should appear
         * like a combobox in its // non-editing state, also set the combobox renderer
    ...
    void jbInit() throws Exception {
        ...
        txtNomTaulaJava.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                /*
                 * String val = txtNomTaulaJava.getText().trim(); /* if (val.length() > 0) {
    ...
    public boolean next() {
        ...
        // Fer-ho per totes les taules
        {
             ...
             * this.txtNomTaulaWeb.getText().trim(); if ("".equals(nomWeb)) {
             * this.txtNomTaulaWeb.setBackground(Color.red); return false; } else {
    ...
    public class MouseAdapterUpDown extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (column == ColumnConfig.EDIT.index) {
                ...
                EditFieldInfo editor = new EditFieldInfo(frame, fields[row], SharedData.data.getLanguages());
                editor.setVisible(true);
    ...
    /*
     * public class MyComboBoxEditor extends DefaultCellEditor { public
     ...
     * value, boolean isSelected, int row, int column) { delegate.setValue(value);
