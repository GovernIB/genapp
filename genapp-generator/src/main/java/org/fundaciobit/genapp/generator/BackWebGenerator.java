...
public class BackWebGenerator extends IconUtils {
	...
	private static String getOnlyReadFileFieldWithoutCondition(Project project, final String model, String modelCamp) {
		return "              <a target=\"_blank\" href=\"<c:url value=\"${"
				+ project.getPrefix().toLowerCase() + ":fileUrl(" + model + "." + modelCamp + ")}\"/>\">${" + model
				+ "." + modelCamp + ".nom}</a>\n";
	}
		...
		*/
		...
		case WebType.RichText:
			...
			if (webType == WebType.TextArea) {
				...
				code.append("                <li><a href=\"#\" onclick=\"javascript:var ta=document.getElementById('"
						+ path + "'); ta.wrap='off';\" >No Wrap</a></li>\n");
				code.append("                <li><a href=\"#\" onclick=\"javascript:var ta=document.getElementById('"
						+ path + "'); ta.wrap='soft';\">Soft Wrap</a></li>\n");
				code.append("                <li><a href=\"#\" onclick=\"javascript:var ta=document.getElementById('"
						+ path + "'); ta.wrap='hard';\">Hard Wrap</a></li>\n");
				code.append("              </ul>\n");
				code.append("              </div>\n");
			}
		...
		case WebType.Date:
			...
			code.append("                        <div class=\"input-group-text\"><i class=\"" + ICON_CALENDAR + "\"></i></div>\n"); 
			code.append("                    </div>\n");
			code.append("                    </c:if>\n");
			code.append("                </div>\n");
			code.append("            </div>\n");
		...
		case WebType.Time:
			...
			code.append("                    <c:if test=\"${!" + readOnlyCondition + "}\" >\n");
			code.append("                    <div class=\"input-group-append\"  data-target=\"#"  + model + "_" + modelCamp + "\"  data-toggle=\"datetimepicker\">\n");
			code.append("                        <div class=\"input-group-text\"><i class=\"" + IconUtils.ICON_CLOCK + "\"></i></div>\n"); 
			code.append("                    </div>\n");
			code.append("                    </c:if>\n");
			code.append("                </div>\n");
			code.append("            </div>\n");
