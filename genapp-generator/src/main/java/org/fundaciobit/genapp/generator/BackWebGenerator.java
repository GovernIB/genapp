...
return sourceFiles;
  ...
  public static String getEmptyTilesXML(String backPackage) {
    ...
    code.append("<!DOCTYPE tiles-definitions PUBLIC  \"-//Apache Software Foundation//DTD Tiles Configuration 3.0//EN\"  \"http://tiles.apache.org/dtds/tiles-config_3_0.dtd\">\n");
    code.append("<tiles-definitions>\n");
    code.append("\n");

    code.append("    <definition name=\"base.cap\" template=\"/WEB-INF/jsp/moduls/cap.jsp\" preparer=\""+ backPackage +".preparer.CapPreparer\"/>\n");
    code.append("    <definition name=\"base.menu_i_contingut\" template=\"/WEB-INF/jsp/moduls/menu_i_contingut.jsp\"/>\n");
    code.append("    <definition name=\"base.menu\" template=\"/WEB-INF/jsp/moduls/blanc.jsp\" preparer=\""+ backPackage +".preparer.MenuPreparer\"/>\n");
    code.append("    <definition name=\"base.contingut\" template=\"/WEB-INF/jsp/moduls/blanc.jsp\"/>\n");
    code.append("    <definition name=\"base.peu\" template=\"/WEB-INF/jsp/moduls/peu.jsp\" preparer=\""+ backPackage +".preparer.PeuPreparer\"/>\n");

    code.append(" <definition name=\"base.contingut\" template=\"/WEB-INF/jsp/moduls/blanc.jsp\"/>\n");
    code.append("\n");
    code.append("    <definition name=\"base.definition\" template=\"/WEB-INF/jsp/layout/layout.jsp\" preparer=\""+ backPackage +".preparer.BasePreparer\">\n");
...
//    code.append("    \n");
  ...
  public static List<SourceFile> generateFormJsp(String packageControllerBack,
    ...
    // ============= JSP PRINCIPAL  
    {
      ...
      codeBase.append("<form:form modelAttribute=\"" + instanceForm + "\" method=\"${(empty method)?'post':method}\"\n");
