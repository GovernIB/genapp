...
public class SQL2Java {
    ...
    protected static Hashtable<Integer, String> sqltype2sqltypename = new Hashtable<Integer, String>();
    protected static Hashtable<String, Integer> java2sql = new Hashtable<String, Integer>();
    protected static Hashtable<Class<?>, Class<?>> object2PrimitiveType = new Hashtable<Class<?>, Class<?>>();
    protected static Hashtable<Class<?>, Class<?>> primitiveType2Object = new Hashtable<Class<?>, Class<?>>();
    protected static Hashtable<String, Class<?>> primitiveTypesNames = new Hashtable<String, Class<?>>();
    ...
    protected static final Object[][] SQL2JAVA = new Object[][] {
            ...
            { Integer.valueOf(Types.LONGVARBINARY), "java.io.InputStream", "LONGVARBINARY" },
    ...
    protected static final Object[][] JAVA2SQL = new Object[][] {
            ...
            { "java.lang.Byte", Integer.valueOf(Types.TINYINT) }, { "java.lang.Long", Integer.valueOf(Types.BIGINT) },
            { "java.math.BigDecimal", Integer.valueOf(Types.NUMERIC) },
            // ============= DECIMAL DATA======================
            { "java.lang.Double", Integer.valueOf(Types.DOUBLE) }, { "java.lang.Float", Integer.valueOf(Types.REAL) },
            // ============ BYNARY DATA I ========================
            { "java.io.OutputStream", Integer.valueOf(Types.VARBINARY) },
            // ============ TIME DATA ========================
            { "java.sql.Date", Integer.valueOf(Types.DATE) }, { "java.sql.Time", Integer.valueOf(Types.TIME) },
    ...
    static {
        ...
        for (x = 0; x < SQL2JAVA.length; x++) {
            ...
            sqltype2sqltypename.put((Integer) SQL2JAVA[x][0], (String) SQL2JAVA[x][2]);
        }
        ...
        for (x = 0; x < OBJECT2PRIMITIVETYPE.length; x++) {
            object2PrimitiveType.put(OBJECT2PRIMITIVETYPE[x][0], OBJECT2PRIMITIVETYPE[x][1]);
        }

        for (x = 0; x < PRIMITIVETYPE2OBJECT.length; x++) {
            primitiveType2Object.put(PRIMITIVETYPE2OBJECT[x][0], PRIMITIVETYPE2OBJECT[x][1]);
            primitiveTypesNames.put(PRIMITIVETYPE2OBJECT[x][0].toString(), PRIMITIVETYPE2OBJECT[x][0]);
        }
        ...
        STRINGTOCLASS.put(java.math.BigDecimal.class.getName(), java.math.BigDecimal.class);
        STRINGTOCLASS.put(java.math.BigInteger.class.getName(), java.math.BigInteger.class);
    ...
    public static String formatValueFromSqlType(int sqlType, String defValueClean) {
        switch (sqlType) {
            case Types.DOUBLE:
            case Types.FLOAT:
                return "(double)" + defValueClean;

            case Types.REAL:
                return "(float)" + defValueClean;
            case Types.NUMERIC:
            case Types.DECIMAL:
                return "new " + java.math.BigDecimal.class.getName() + "(" + defValueClean + ")";
            default:
                return defValueClean;
        }
