...
public class TableModelColumnList extends AbstractTableModel {
     ...
     * public static final int JAVA_TYPE=; public static final int SQL_NAME=; public
     * static final int SQL_TYPE=; public static final int SIZE=; public static
     * final int FOREIGNKEYS=; public static final int WEBTYPE=; public static final
     * int WEBADDTYPE=;
     */
    ...
    public enum ColumnConfig {
         ...
         * java.lang.String.class, java.lang.String.class, }; boolean columnIsEditable[]
         * = {false, false, true, true, false, false, false, false, };
         */

        PRIMARY_KEY(0, "PK", Boolean.class, false, 29), NOT_NULL(1, "NN", Boolean.class, true, 29),
        AUTOINCREMENT(2, "AU", Boolean.class, true, 29), LABEL(3, "Label", String.class, false, 86),
        JAVA_NAME(4, "Java Name", String.class, true, 86), JAVA_TYPE(5, "Java Type", String.class, true, 100),
        SQL_NAME(6, "SQL Name", String.class, false, 95), SQL_TYPE(7, "SQL Type", String.class, false, 95),
        SIZE(8, "Size", String.class, false, 35), FOREIGNKEYS(9, "ForeignKeys", String.class, false, 150),
        WEBTYPE(10, "WebType", JComboBox.class, true, 90), WEBQUERYVALUE(11, "QueryValue", String.class, true, 90),
        WEBQUERY(12, "WebQuery", String.class, false, 150), UP(13, "", JButton.class, false, 35),
        DOWN(14, "", JButton.class, false, 35), EDIT(15, "", JButton.class, false, 35);
        ...
        private ColumnConfig(int index, String columnName, Class<?> javaType, boolean isEditable, int width) {
            this.index = index;
        ...
        /*
         * public static ColumnConfig fromString(final String str) { for (ColumnConfig e
         * : ColumnConfig.values()) { if (e.toString().equalsIgnoreCase(str)) { return
         * e; } } return null; }
         */
     ...
     * null) 3 TABLE_NAME String => table name 4 COLUMN_NAME String => column name 5
     * DATA_TYPE short => SQL type from java.sql.Types 6 TYPE_NAME String => Data
     * source dependent type name, for a UDT the type name is fully qualified 7
     * COLUMN_SIZE int => column size. For char or date types this is the maximum
     * number of characters, for numeric or decimal types this is precision. 8
     * BUFFER_LENGTH is not used. 9 DECIMAL_DIGITS int => the number of fractional
     * digits 10 NUM_PREC_RADIX int => Radix (typically either 10 or 2) 11 NULLABLE
     ...
     * nullability unknown 12 REMARKS String => comment describing column (may be
     * null) 13 COLUMN_DEF String => default value (may be null) 14 SQL_DATA_TYPE
     * int => unused 15 SQL_DATETIME_SUB int => unused 16 CHAR_OCTET_LENGTH int =>
     * for char types the maximum number of bytes in the column 17 ORDINAL_POSITION
     * int => index of column in table (starting at 1) 18 IS_NULLABLE String => "NO"
     * means column definitely does not allow NULL values; "YES" means the column
    ...
    public TableModelColumnList(String tableName, FieldInfo[] fields) throws Exception {
        ...
        for (int j = 0; j < fields.length; j++) {
            ...
            JComboBox<WebFieldInfo> box = new JComboBox<WebFieldInfo>(availables);
    ...
    public Object getValueAt(int aRow, int aColumn) {
        ...
        switch (config) {
            ...
            /*
             * case WEBQUERYKEY: { WebFieldInfo webFI = row.webFieldInfo; if
             * (webFI.webtype.equals(WebType.Query)) { return webFI.foreignKey.getField(); }
             * else { return "-"; } }
             */
            case WEBQUERYVALUE: {
            ...
            case WEBQUERY: {
                ...
                if (webFI.webtype == WebType.Query) {
                    return "Reference to " + webFI.foreignKey.getTable() + "[" + webFI.foreignKey.getField() + "]";
                } else {
                    return ProjectUtils.createSelect(this.tableName, row, "");
                }
                /*
                 * WebFieldInfo webFI = row.webFieldInfo; if
                 * (webFI.webtype.equals(WebType.Query)) { return webFI.createSelect(); } else {
                 * return row.javaName; }
                 */
            }
            case UP:
    ...
    public void setValueAt(Object value, int row, int column) {
        ...
        switch (config) {
            ...
            case JAVA_TYPE: {
                ...
                /*
                 * try { // @todo ComboBox compatible types
                 * field.setJavaType(Class.forName((String)value)); }
                 * catch(ClassNotFoundException e) { // Is Primitive Class<?> primitiveType =
                 * SQL2Java.primitiveType2javaClassName((String)value); if (primitiveType ==
                 * null) { e.printStackTrace(); JOptionPane.showMessageDialog(null, "Error: " +
                 * e.getMessage()); } else { field.setJavaType(primitiveType); } }
                 */
            }
            break;
     ...
     * //JOptionPane.showMessageDialog(null, "ROW: " + udb.index + " | ISUP: " +
     * udb.isUp);
     * 
     * }
     */
