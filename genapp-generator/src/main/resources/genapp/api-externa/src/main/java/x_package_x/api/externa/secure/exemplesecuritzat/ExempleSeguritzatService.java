...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST EXTERNA de ${fullname} - Exemple de Servei Securitzat",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/${name}/tree/${name}-1.0/${name}-api-externa-client-exemplesecure-v1"))
...
public class ExempleSeguritzatService {
    ...
    @Path("/echo")
    @GET
    @RolesAllowed({ <#list ws_roles as role>Constants.${role?upper_case}, </#list>})
