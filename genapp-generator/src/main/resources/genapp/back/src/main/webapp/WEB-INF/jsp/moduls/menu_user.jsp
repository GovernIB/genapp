  ...
  <ul class="tree" style="margin: 3px; padding: 0px;">
    ...
    <li style="list-style-type: disc; list-style-position: inside;">
      <a href="<c:url value="/user/option1"/>">
        <span style="${dollar}{(fn:contains(url, 'option1'))? "font-weight: bold;" : ""}">Menú USER Option 1</span>
      </a>
    </li>
   ...
   <sec:authorize access="hasAnyRole('ROLE_SOLI', 'ROLE_DEST', 'ROLE_COLA', 'ROLE_DELE')">
    ...
    <li style="list-style-type: disc; list-style-position: inside;">
      <a href="<c:url value="/user/option2"/>">
        <span style="${dollar}{(fn:contains(url, 'option2'))? "font-weight: bold;" : ""}">Menú USER Option 2</span>
      </a>
    </li>
