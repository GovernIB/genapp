package ${package}.back.config;

import java.util.Locale;

import org.fundaciobit.demogenapp.utils.Configuracio;
...
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new ${package}.back.utils.${fullname}SessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new ${package}.back.security.DefaultRolesPrefixPostProcessor();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/${name}_genapp", "/WEB-INF/classes/genapp");
